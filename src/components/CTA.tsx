      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center text-white">
          ...
          <p className="text-xl mb-12 text-white/90 max-w-3xl mx-auto leading-relaxed">
            Ready to unlock your business potential? Our expert consultants are
            here to guide you through every step of your transformation journey.
            Book your free consultation and take the first step toward
            sustainable growth.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white/30 text-primary hover:bg-white/90 hover:text-primary transition-smooth text-lg px-10 py-6"
            >
          ...
          <div className="mt-16 pt-12 border-t border-white/20">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto border border-white/10">
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                We're so confident in our ability to help transform your
                business that we offer a
                <span className="text-accent font-semibold">
                  {" "}
                  100% satisfaction guarantee
                </span>{" "}
                on all our consultancy services. Your success is our success.
              </p>
            </div>
          </div>
        </div>
