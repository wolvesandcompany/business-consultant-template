        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-xl mb-8 text-white/90 leading-relaxed">
              We help small to medium enterprises achieve sustainable growth through expert consultancy in business strategy, financial planning, and digital transformation.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-white/30 text-white hover:bg-white hover:text-primary transition-smooth"
              >
                Learn More About Us
              </Button>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-white/20">
              <div className="grid grid-cols-3 gap-8 text-center">
                <div>
                  ...
                  <p className="text-white/80 text-sm">Businesses Transformed</p>
                </div>
                <div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl p-6 shadow-card">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Average Growth</p>
                  </div>
                </div>
              </div>
            </div>
